    ...
    def setup(self, stage=None):
        ...
        if stage == 'fit' or stage is None:
            ...
            if self.tokenizer is None:
                ...
                # Load the training dataset first to train the tokenizer
                temp_train_dataset = load_dataset("wikitext", "wikitext-2-raw-v1", split='train')
                self.tokenizer.train(temp_train_dataset)
        ...
        elif stage == 'test':  # Changed if to elif since stages are mutually exclusive
